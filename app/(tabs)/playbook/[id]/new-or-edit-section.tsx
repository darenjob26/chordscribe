...
export default function NewOrEditSectionScreen() {
  ...
  const { addSection, updateSection } = useSong()
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <ScrollView className="flex-1 p-4">
        ...
        <View className="mb-6">
          ...
          <View className="flex-row gap-2">
            ...
            <View className="flex-1">
              <ThemedButton
                variant="outline"
                title={editingLineId ? "Save Line" : "New Line"}
        ...
        {currentLine.chords.length > 0 && <View className="mb-6 p-4 border rounded-lg border-border">
          <Text className="text-base font-medium mb-2" style={{ color: colors.text }}>
            {editingLineId ? "Editing Line" : "Current Line"}
          </Text>
          <View className="flex-row flex-wrap gap-2">
